...
describe('BinarySearchTreeNode', () => {
  ...
  it('should add nodes in correct order', () => {
    const bstNode = new BinarySearchTreeNode(2)
  ...
  it('it should not add the same values', () => {
    const bstNode = new BinarySearchTreeNode(2)
    bstNode.insert(1)
  ...
  it('should add additional info to nodes', () => {
    const node = new BinarySearchTreeNode(10)
  ...
  it('should remove node without parents', () => {
    const bstRootNode = new BinarySearchTreeNode()
  ...
  it('should remove non-existed node', () => {
    const bstRootNode = new BinarySearchTreeNode()
  ...
  it('should make null parents deleted node', () => {
