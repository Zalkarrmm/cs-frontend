...
describe('Binary Tree Node', () => {
  ...
  it('should get a height of nodes', () => {
  ...
  it('should get a height of right nodes', () => {
    const root = new BinaryTreeNode(1)
    const right = new BinaryTreeNode(2)
  ...
  it('should make null left and right nodes', () => {
  ...
  it('should add additional info to node', () => {
  ...
  it('should set up value of node', () => {
