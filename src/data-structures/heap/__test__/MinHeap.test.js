...
describe('MinHeap', () => {
    ...
    it('should remove elements from heap and heapifyDown', () => {
        ...
        expect(minHeap.remove(3).peek()).toEqual(10)
        expect(minHeap.remove(3).toString()).toEqual('10,12')
    })

    it('should delete elements from minHeap and heapifyUp', () => {
        const minHeap = new MinHeap()
    ...
    it('should delete elements from minheap finded by custom compare function', () => {
      const minHeap = new MinHeap()
      minHeap.add('dddd')
      minHeap.add('ccc')
      minHeap.add('bb')
    ...
    it('should delete elements from heap by correctly restructurizing of tree', () => {
      const minHeap = new MinHeap()
